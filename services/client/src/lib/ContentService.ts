...
export class ContentService implements IContentProvider {
  ...
  getPhasesContent(): IPhasesContent {
    return {
      label: "The Vision",
      titleLines: ["A conglomerate", "that compounds."],
  ...
  getStatStripContent(): IStatStripContent {
    return {
      stats: [
        { value: "4",  label: "Central departments powering\nevery child company"        },
        { value: "95", sup: "%", label: "Target automation of all\nwhite-collar desk work" },
        { value: "5",  label: "Phases from engine to\nself-sufficient conglomerate"       },
        { value: "≈0", label: "Marginal cost of adding\neach new child company"           },
      ],
    };
  }
